...
export class FlowMapbox {
  ...
  prepareResource(gl) {
    ...
    const projectionTexture2D = createMyTexture(gl, 1, gl.TEXTURE_2D, WebGL2RenderingContext.RG32F, 0, 0);
    fillTexture(
      gl,
    ...
    this._textureMap.set(FlowEnum.PROJECTION_MAPBOX_TEXTURE, projectionTexture2D);
